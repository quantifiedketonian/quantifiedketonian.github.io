...
That said, as I’ve mentioned on my [about page]({{ site.baseurl }}{% link page/index.html %}), I started doing keto out of fear of getting diabetes. So since I’m fat adapted, I figured it was time to start doing some of the carb tolerance tests that Robb Wolf talks about in his book. As my first published experiment, I wanted to understand how two common “paleo” sweeteners affect my metabolic state.
